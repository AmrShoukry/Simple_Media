...
const { handleCreatingPost, handleDeletingPost, handleLikingPost, handleUnlikingPost, getAllPosts, getUserPosts, getMyPosts, getPost, getPostLikes } = require("../controllers/postsController");
...
postsRouter.route('/:postId/likes').post(handleLikingPost).delete(handleUnlikingPost).get(getPostLikes)
